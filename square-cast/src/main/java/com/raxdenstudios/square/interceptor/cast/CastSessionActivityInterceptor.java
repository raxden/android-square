...
public class CastSessionActivityInterceptor
        extends ActivityInterceptor<CastSessionInteractor, CastSessionInterceptorCallback>
        implements CastSessionInteractor {
