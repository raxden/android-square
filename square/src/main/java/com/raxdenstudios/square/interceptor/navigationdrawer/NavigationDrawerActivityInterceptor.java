package com.raxdenstudios.square.interceptor.navigationdrawer;
 ...
 */
public class NavigationDrawerActivityInterceptor<TFragment extends Fragment>
        extends ActivityInterceptor<NavigationDrawerInteractor, NavigationDrawerInterceptorCallback<TFragment>>
        implements NavigationDrawerInteractor {

    private View mContentDrawerView;
    private DrawerLayout mDrawerLayout;
    private ActionBarDrawerToggle mDrawerToggle;

    public NavigationDrawerActivityInterceptor(Activity activity, NavigationDrawerInterceptorCallback<TFragment> callback) {
