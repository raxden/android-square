 ...
 */
public class FragmentStatePagerActivityInterceptor<TFragment extends Fragment>
        extends ActivityInterceptor<FragmentStatePagerInteractor<TFragment>, FragmentStatePagerInterceptorCallback<TFragment>>
        implements FragmentStatePagerInteractor<TFragment> {
