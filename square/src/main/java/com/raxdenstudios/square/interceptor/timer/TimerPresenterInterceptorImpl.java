 ...
 */
public class TimerPresenterInterceptorImpl<TView extends IView> extends PresenterInterceptor<TView, TimerInterceptorCallback> implements TimerInterceptor {
    ...
    public TimerPresenterInterceptorImpl(@NonNull Presenter presenter) {
        super(presenter);
        init();
    }

    public TimerPresenterInterceptorImpl(@NonNull Presenter presenter, @NonNull TimerInterceptorCallback callback) {
