 ...
 */
public abstract class AsyncTaskImproved<Params, Progress, Result> {
     ...
     */
    public final AsyncTaskImproved<Params, Progress, Result> execute(Params... params) {
     ...
     * @see #execute(Object[])
     */
    public final AsyncTaskImproved<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final AsyncTaskImproved mTask;
        final Data[] mData;

        AsyncTaskResult(AsyncTaskImproved task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
